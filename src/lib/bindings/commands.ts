...
export const commands = {
	...
	updateTrackLocked: (id: string, locked: boolean) => typedError<null, IpcError_Serialize>(__TAURI_INVOKE("update_track_locked", { id, locked })),
	updateTrackMuted: (id: string, muted: boolean) => typedError<null, IpcError_Serialize>(__TAURI_INVOKE("update_track_muted", { id, muted })),
