...
fn make_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::audio::create_shot_audio,
            commands::audio::delete_shot_audio,
            commands::audio::list_shot_audio,
            commands::audio::update_shot_audio,
            ...
            commands::dialog::pick_media_file,
            ...
            commands::ffmpeg::check_audio_alignment,
            ...
            commands::ffmpeg::extract_waveform,
            commands::ffmpeg::probe_audio_duration,
            ...
            commands::shot::adopt_task_result,
            ...
            commands::timeline::delete_timeline_item,
            ...
            commands::timeline::list_color_effect_presets,
            commands::timeline::list_ken_burns_presets,
            commands::timeline::list_sticker_presets,
            ...
            commands::video::update_video_clip,
            commands::voice::generate_episode_voices,
            commands::voice::generate_shot_voice,
            commands::voice::preview_voice,
